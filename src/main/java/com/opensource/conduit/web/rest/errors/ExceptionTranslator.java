package com.opensource.conduit.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.opensource.conduit.service.EmailAlreadyUsedException ||
            ex instanceof com.opensource.conduit.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.opensource.conduit.service.InvalidPasswordException
